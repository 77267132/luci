...
function smartdnsRenderStatus(res) {
	...
	if (isRunning) {
		renderHTML += "<span style=\"color:green;font-weight:bold;display:block;height:30px;line-height:30px;\">SmartDNS - " + _("RUNNING") + "</span>";
	} else {
		renderHTML += "<span style=\"color:red;font-weight:bold;display:block;height:30px;line-height:30px;\">SmartDNS - " + _("NOT RUNNING") + "</span>";
		return renderHTML;
	}
